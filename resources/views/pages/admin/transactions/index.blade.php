    ...
    <div class="row d-flex justify-content-center">
            ...
            @endif
                ...
                <div class="card-body text-secondary">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col col-8">
                            @if ($products[$keyOrder]["transaction_data"][0]->status_code !== 407)    
                            <form method="POST" action="{{ route('refund.transaction', $keyOrder) }}">
                                @csrf
                            ...
                            <a href="{{ url("/admin/transaction/$keyOrder/details") }}" class="btn btn-info btn-icon-split float-right">
                                <span class="icon text-white-50">
                                    <i class="fas fa-info-circle"></i>
                                </span>
                                <span class="text">Detail Pesanan</span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        {{-- <div class="col-12 col-sm-12 col-md-6 col-xl-6">
            <div class="card mb-3 shadow" style="max-width: 100%;">
                <div class="card-header">2 Jan 2021</div>
                <div class="card-body text-secondary">
                    <div class="row">
                        <div class="col col-4">
                        ...
                        <div class="col col-8">
                            <h5 class="card-title">Ikan Tuna</h5>
                            <p class="card-text">Jumlah Pesan: x5 <br> Pemesan: iyan@gmail.com</p>
                    ...
                    <div class="row mt-2">
                        <div class="col col-4">
                            <small>
                                <p>Total Transfer <br> Rp. 500000</p>
                            </small>
                        </div>
                        <div class="col col-8">
                            <button class="btn btn-warning float-right ml-2">
                                Refund
                            </button>
